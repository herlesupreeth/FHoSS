...
<table id="navigation" height="100%">
	...
	<tr id="bound_bottom">
		...
		<td id="level01" colspan="2">
			...
			<a href="pages/profiles" target="main">User Profiles</a>
			<a href="pages/ifc" target="main">Service Profiles</a>			
			<a href="pages/network" target="main">Network Infrastructure</a>
			<a href="pages/info" target="main">Info</a>
		</td>
