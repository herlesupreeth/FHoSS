				...
				<tr>
	 			...
	 			<tr>
	 				<td>
		    			...
		    			<tr bgcolor="#FFCC66">
							<td>ID</td>
							<td><html:text property="id_dsai" value="" styleClass="inputtext" style="width:100px;"/></td>
						</tr>
		    			<tr bgcolor="#FFCC66">
		    				<td>DSAI-Tag</td>
							<td><html:text property="dsai_tag" value="" styleClass="inputtext" style="width:200px;"/></td>
						</tr>
						</table>
					</td>
				</tr>
