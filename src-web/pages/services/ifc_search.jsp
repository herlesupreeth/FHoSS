...
<body>
	...
	<tr>
		<td align="center">
			<h1> Initial Filter Criteria - Search </h1> 			
			<br/><br/>
		</td>
	</tr>
	</table> <!-- title-table -->
		...
		<tr height=99%>
			<td align=center>
				...
				<tr><td align="right"><b>Enter Search Parameters:</b></td></tr>
	 			<tr>
	 				<td>
					 	<table id="fields-table" class="as" border="0" cellspacing="1" align="center" width="400" style="border:2px solid #FF6600;">
		    			<tr bgcolor="#FFCC66">
							<td>ID</td>
							<td><html:text property="id_ifc" value="" styleClass="inputtext" style="width:100px;"/></td>
						</tr>
		    			<tr bgcolor="#FFCC66">							
		    				<td>Name</td>
						...
						<tr bgcolor="#FFCC66">	
							<td>AS Name</td>
							<td><html:text property="name_application_server" value="" styleClass="inputtext" style="width:200px;"/></td>
						</tr>
						<tr bgcolor="#FFCC66">	
							<td>TP Name</td>
							<td><html:text property="name_tp" value="" styleClass="inputtext" style="width:200px;"/></td>
						</tr>
						</table>
					</td>		
				</tr>
