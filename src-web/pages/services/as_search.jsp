...
<body>
	...
	<tr>
		<td align="center">
			<h1> Application Server - Search </h1> 			
			<br/><br/>
		</td>
	</tr>
	</table> <!-- title-table -->
				...
				<tr><td align="right"><b>Enter Search Parameters:</b></td></tr>
	 			<tr>
	 				<td>
		    			...
		    			<tr bgcolor="#FFCC66">
							<td>ID</td>
							<td><html:text property="id_as" value="" styleClass="inputtext" style="width:100px;" /></td>
						</tr>
		    			<tr bgcolor="#FFCC66">							
		    				<td>Name</td>
		    			...
		    			<tr bgcolor="#FFCC66">							
							<td>Server-Name</td>
							<td>
								<html:text property="server_name" value="" styleClass="inputtext" style="width:200px;"/>
							</td>
						</tr>
						</table> <!-- fields-table -->
					</td>		
