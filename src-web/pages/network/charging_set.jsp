...
<body>
	...
	<html:form action="/CS_Submit">
		<html:hidden property="nextAction" value=""/>
			...
			<tr>
				<td>
			 		<table id="chg-table" border="0" align="center" width="400" >						
			 		<tr>
			 				<td>
								...
								<tr bgcolor="#FFCC66">
									<td>Primary CCF* </td>
									<td><html:text property="pri_ccf" styleClass="inputtext" style="width:200px;"/> </td>
								</tr>
								<tr bgcolor="#FFCC66">
									<td>Secondary CCF  </td>
									<td><html:text property="sec_ccf" styleClass="inputtext" style="width:200px;"/> </td>
								</tr>
								<tr bgcolor="#FFCC66">
									<td>Primary ECF </td>
									<td><html:text property="pri_ecf" styleClass="inputtext" style="width:200px;"/> </td>
								</tr>
								<tr bgcolor="#FFCC66">
									<td>Secondary ECF  </td>
									<td><html:text property="sec_ecf" styleClass="inputtext" style="width:200px;"/> </td>
								</tr>
								</table>	<!-- fields-table -->	
							</td>
					</tr>
