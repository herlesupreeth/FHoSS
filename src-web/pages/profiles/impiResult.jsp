	...
	<tr id="bound_bottom_black">
		<td valign="top" bgcolor="#FFFFFF"><logic:notEmpty name="result">
			<table class="as" width="500">
				<tr class="header">
					<td class="header"><bean:message key="impi.head.id" /></td>
					<td class="header"><bean:message key="form.head.action" /></td>
				</tr>
				<logic:iterate name="result" id="impi"
				...
				<tr>
					<td colspan="3" class="header"><script type="text/javascript"
						...
						function submitForm(pageId){
							document.impiSearchForm.page.value = pageId;
							document.impiSearchForm.submit();
						}
					</script> <html:form action="/impiSearch">
						<table>
							<tr>
				...
				%></td>
								...
								<html:hidden property="impiString"></html:hidden> <html:hidden
									property="page"></html:hidden> <html:select
									property="rowsPerPage"
									onchange="javascript:document.impiSearchForm.submit();">
									<option value="20"
