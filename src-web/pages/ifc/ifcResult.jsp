	...
	<tr id="bound_bottom_black">
		<td valign="top" bgcolor="#FFFFFF"><logic:notEmpty name="result">
			<table class="as" width="500">
				...
				<logic:iterate name="result" id="ifc"
					type="de.fhg.fokus.hss.model.Ifc" indexId="ix">
					<tr class="<%= ix.intValue()%2 == 0 ? "even" : "odd" %>">
						<td><bean:write name="ifc" property="name" /></td>
						<td align="center">
							<table>
								<tr>
									<td>
									...
									<td>
									<form method="post" action="/hss.web.console/ifcDelete.do"
										target="content" style="text-align: center"><input type="hidden"
										name="ifcId"
										value="<bean:write name="ifc" property="ifcId" />"> <input
				...
				<tr>
					<td colspan="3" class="header"><script type="text/javascript"
						...
						function submitForm(pageId){
							document.ifcSearchForm.page.value = pageId;
							document.ifcSearchForm.submit();
						}
					</script> <html:form action="/ifcSearch">
						<table>
							<tr>
				...
				%></td>
								...
								<html:hidden property="ifcName"></html:hidden> <html:hidden
									...
									onchange="javascript:document.ifcSearchForm.submit();">
									<option value="20"
