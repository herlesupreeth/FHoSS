	...
	<tr id="bound_bottom_black">
		<td valign="top" bgcolor="#FFFFFF"><logic:notEmpty name="result">
			<table class="as" width="500">
				<tr class="header">
					<td><bean:message key="as.head.asName" /></td>
					<td><bean:message key="form.head.action" /></td>
				</tr>
				<logic:iterate name="result" id="apsvr"
					type="de.fhg.fokus.hss.model.Apsvr" indexId="ix">
						...
						<td align="center">
							<table>
								<tr>
									...
									<td>
									<form method="post" action="/hss.web.console/asDelete.do"
										target="content" style="text-align: center"><input type="hidden"
										name="asId"
										value="<bean:write name="apsvr" property="apsvrId" />"> <input
				...
				<tr>
					<td colspan="3" class="header"><script type="text/javascript"
						...
						function submitForm(pageId){
							document.asSearchForm.page.value = pageId;
							document.asSearchForm.submit();
						}
					</script> <html:form action="/asSearch">
						<table>
							<tr>
				...
				%></td>
								...
								<html:hidden property="asName"></html:hidden> <html:hidden
									property="page"></html:hidden> <html:select
									property="rowsPerPage"
									onchange="javascript:document.asSearchForm.submit();">
									<option value="20"
