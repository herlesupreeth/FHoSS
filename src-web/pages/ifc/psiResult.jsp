		...
		<td valign="top" bgcolor="#FFFFFF"><logic:notEmpty name="result">
			<table class="as" width="500">
				...
				<logic:iterate name="result" id="psi"
					type="de.fhg.fokus.hss.model.Psi" indexId="ix">

					<tr class="<%= ix.intValue()%2 == 0 ? "even" : "odd" %>">
						<td><bean:write name="psi" property="name" /></td>
						<td align="center">
							<table>
								<tr>
									<td>
									<form method="post" action="/hss.web.console/psiShow.do"
										target="content" style="text-align: center"><input type="hidden"
										name="psiId"
										value="<bean:write name="psi" property="psiId" />"> <input
										type="image" src="/hss.web.console/images/edit_small.gif"></form>
									</td>
									<% if(request.isUserInRole(SecurityPermissions.SP_PSI)) { %>
									<td>
									<form method="post" action="/hss.web.console/psiDelete.do"
										target="content" style="text-align: center"><input type="hidden"
										name="psiId"
										value="<bean:write name="psi" property="psiId" />"> <input
				...
				<tr>
					<td colspan="3" class="header"><script type="text/javascript"
						...
						function submitForm(pageId){
							document.psiSearchForm.page.value = pageId;
							document.psiSearchForm.submit();
						}
					</script> <html:form action="/psiSearch">
						<table>
							<tr>
				...
				%></td>
								...
								<html:hidden property="psiName"></html:hidden> <html:hidden
									...
									onchange="javascript:document.psiSearchForm.submit();">
									<option value="20"
