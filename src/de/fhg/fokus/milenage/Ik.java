 ...
 */
public class Ik extends Auth3gppObject
{
    public static final int STRING_LENGTH=128/4;
    public static final int BYTES_LENGTH=128/8;
    
    public Ik(byte[] bytes)
	{
		super(bytes, BYTES_LENGTH, 0, HexCoDec.CODEC_NAME);
	}
	
    public Ik(String hex) throws CoDecException
	{
