 ...
 */
public class Amf extends Auth3gppObject
{
    public static final int STRING_LENGTH=4;
    public static final int BYTES_LENGTH=2;
    public static String DEFAULT_AMF = "0000";
    public static final String PROPERTY_NAME= "de.fhg.fokus.milenage.AMF";
    public Amf(byte[] bytes)
	{
		super(bytes, BYTES_LENGTH, 0, HexCoDec.CODEC_NAME);
	}
	
    public Amf(String hex) throws CoDecException
	{
		super(hex, STRING_LENGTH, HexCoDec.CODEC_NAME);
	}
    
    public Amf(byte[] bytes, int length, int startIndex)
    {
