 ...
 */
public class Op extends Auth3gppObject
{
    public static final int STRING_LENGTH=32;
    public static final int BYTES_LENGTH=16;
    public static String DEFAULT_OP = "63bfa50ee6523365ff14c1f45f88737d";
    public static final String PROPERTY_NAME= "de.fhg.fokus.milenage.OP";
    
    public Op(byte[] bytes)
	{
		super(bytes, BYTES_LENGTH, 0, HexCoDec.CODEC_NAME);
	}
	
    public Op(String hex) throws CoDecException
	{
