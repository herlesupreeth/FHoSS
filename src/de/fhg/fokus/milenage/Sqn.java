 ...
 */
public abstract class Sqn extends Auth3gppObject
{
    public static final String PROPERTY_SQNRANGE="de.fhg.fokus.milenage.SQN_RANGE";
    
    public static final String PROPERTY_NAME= "de.fhg.fokus.milenage.SQN";
    
    public static long SQN_RANGE = 1L;
    ...
    Sqn(String hex) throws CoDecException
    {
        super(hex, STRING_LENGTH, HexCoDec.CODEC_NAME);
    }

    Sqn(byte[] bytes, int length, int startIndex)
    {
        super(bytes, length, startIndex, HexCoDec.CODEC_NAME);
    }

    public abstract Sqn calculateNextSqn() throws CoDecException;

    public abstract boolean isInRange(Sqn sqn);
