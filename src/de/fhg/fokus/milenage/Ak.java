 ...
 */
public class Ak extends Auth3gppObject
{
    public static final String PROPERTY_USEAK="de.fhg.fokus.milenage.USE_AK";
    public static boolean USE_AK = false;
    
    public static final int STRING_LENGTH=12;
    public static final int BYTES_LENGTH=6;
    
    public Ak(byte[] bytes)
	{
		super(bytes, BYTES_LENGTH, 0, HexCoDec.CODEC_NAME);
	}
	
    public Ak(String hex) throws CoDecException
	{
