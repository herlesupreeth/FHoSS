...
{
    /* (non-Javadoc)
     * @see de.fhg.fokus.milenage.codec.CoDec#encode(byte[])
     */
    ...
    /**
     * (non-Javadoc)
     * @see de.fhg.fokus.milenage.codec.CoDec#decode(java.lang.String)
     */
    public byte[] decode(String string) throws CoDecException
    {
        return decode(string, string.length());
    }
    ...
    {
        return encode(bytes, requestedLength, 0);
    }
}
