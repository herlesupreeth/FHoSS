 ...
 */
public class UserUnknown extends PermanentFailures {

    /**
     * the code of the Diameter error
     */
    public final static int ERRORCODE = 5001;
     ...
     */
    public UserUnknown(String message) {
     ...
     */
    public UserUnknown(Throwable cause) {
     ...
     *            the cause for this exception
     */
    public UserUnknown(String message, Throwable cause) {
