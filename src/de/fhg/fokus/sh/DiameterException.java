...
public class DiameterException extends Exception implements DiameterResultCode {
     ...
     */
    public DiameterException(long errorcode) {
        super();
     ...
     *            the number of the error
     */
    public DiameterException(String message, long errorcode) {
        super(message);
        this.errorcode = errorcode;
    }
     ...
     *            the number of the error
     */
    public DiameterException(Throwable cause, long errorcode) {
        super(cause);
        this.errorcode = errorcode;
    }
     ...
     *            the number of the error
     */
    public DiameterException(String message, Throwable cause, long errorcode) {
        super(message, cause);
        this.errorcode = errorcode;
    }
     ...
     * (non-Javadoc)
     * 
     * @see de.fhg.fokus.sh.DiameterResultCode#getErrorCode()
     */
    public long getCode() {
        return errorcode;
    }
