...
/**
 * Thrown if the size of the pushed data to the receiving entity exceeds its
 * capacity.
 * 
 * @author Elmar Fasel, fasel -at- fokus dot fraunhofer dot de
 * @version $Revision$ $Date$
 */
public class TooMuchData extends PermanentFailures {

    /**
     * the code of the Diameter error
     */
    public final static int ERRORCODE = 5008;
     ...
     */
    public TooMuchData(Throwable cause) {
     ...
     *            the cause for this exception
     */
    public TooMuchData(String message, Throwable cause) {
