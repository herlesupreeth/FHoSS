...
/**
 * Thrown if an operation is not allowed to be called by a client.
 * 
 * @author Elmar Fasel, fasel -at- fokus dot fraunhofer dot de
 * @version $Revision$ $Date$
 */
public class OperationNotAllowed extends PermanentFailures {

    /**
     * the code of the Diameter error
     */
    public final static int ERRORCODE = 5101;
