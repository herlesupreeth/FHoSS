...
/**
 * It is thrown when a query for location information is received for a public 
 * identity that has not been registered before. The user to which this identity
 * belongs cannot be given service in this situation.
 * 
 * @author Peter Weik (pwe at fokus dot fraunhofer dot de)
 *
 */
public class IdentityNotRegistered extends IMSPermanentFailures {
     ...
     */		
	public IdentityNotRegistered(String message){
     ...
     */		
	public IdentityNotRegistered(Throwable cause){
     ...
     *            the cause for this exception
     */		
	public IdentityNotRegistered(String message, Throwable cause){
