 ...
 */
public class IMSPermanentFailures extends DiameterIMSException {
     ...
     */
    public IMSPermanentFailures(int errorcode) {
        super(errorcode);
    }
     ...
     *            the number of the error
     */
    public IMSPermanentFailures(String message, int errorcode) {
     ...
     *            the number of the error
     */
    public IMSPermanentFailures(Throwable cause, int errorcode) {
     ...
     *            the number of the error
     */
    public IMSPermanentFailures(String message, Throwable cause, int errorcode) {
