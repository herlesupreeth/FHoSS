...
/**
 * It is used by HSS to inform the ICSCF that <br>
 * - The user is authorized to register this public identity <br>
 * - A S-CSCF is already assigned for services related to unregistered state <br>
 * - It may be necessary to assign a new S-CSCF to the user.
 * 
 * @author Peter Weik (pwe at fokus dot fraunhofer dot de)
 *
 */
public class ServerSelection extends IMSSuccess {

	/**
	 *  code of diameter result
	 */		
	public static final int ERRORCODE = 2005;

	/**
     * Create a new instance of ServerSelection
     */		
     ...
     */		
	public ServerSelection(String message){
     ...
     */		
	public ServerSelection(Throwable cause) {
     ...
     *            the cause for this result
     */	
	public ServerSelection(String message, Throwable cause){
