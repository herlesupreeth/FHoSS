...
/**
 * It is used by HSS to inform the concerned peer that the user is not allowed
 * to roam in the visited network.
 * 
 * @author Peter Weik (pwe at fokus dot fraunhofer dot de)
 *
 */
public class RoamingNotAllowed extends IMSPermanentFailures {
     ...
     */	
	public RoamingNotAllowed(String message){
     ...
     */	
	public RoamingNotAllowed(Throwable cause){
     ...
     *            the cause for this exception
     */	
	public RoamingNotAllowed(String message, Throwable cause){
