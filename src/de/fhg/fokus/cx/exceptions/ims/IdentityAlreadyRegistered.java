...
/**
 * It is thrown when The identity being registered has already a server assigned 
 * and the registration status does not allow that it is overwritten.
 * 
 * @author Peter Weik (pwe at fokus dot fraunhofer dot de)
 *
 */
public class IdentityAlreadyRegistered extends IMSPermanentFailures {

    /**
     * the code of the Diameter error
     */
	public static final int ERRORCODE = 5005;

    /**
     * Create a new instance of this exception.
     */		
	public IdentityAlreadyRegistered(){
		super(ERRORCODE);
	}
     ...
     */
	public IdentityAlreadyRegistered(String message){
     ...
     */		
	public IdentityAlreadyRegistered(Throwable cause){
     ...
     *            the cause for this exception
     */		
	public IdentityAlreadyRegistered(String message, Throwable cause){
