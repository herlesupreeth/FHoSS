...
/**
 * Thrown if a generic Diameter base exception occured.
 * 
...
public class DiameterBaseException extends DiameterException {
    ...
    /**
     * Create a DiameterBaseException with a specific errorcode.
     * 
     * @param errorcode
    ...
    /**
     * Create a DiameterBaseException with an explanatory message and a specific
     * errorcode.
     * 
     * @param message
    ...
    /**
     * Create a DiameterBaseException with a specific cause and errorcode.
     * 
     * @param cause
    ...
    /**
     * Create a DiameterBaseException with an explanatory message, a specific cause
     * and errorcode.
     * 
     * @param message
     *            human readable explanation for this error
