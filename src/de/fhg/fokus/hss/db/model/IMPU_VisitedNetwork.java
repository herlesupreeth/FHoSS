...
public class IMPU_VisitedNetwork implements Serializable{
	...
	public int getId_visited_network() {
		return id_visited_network;
	}

	public void setId_visited_network(int id_visited_network) {
		this.id_visited_network = id_visited_network;
	}
