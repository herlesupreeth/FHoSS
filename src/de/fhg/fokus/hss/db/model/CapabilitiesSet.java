...
public class CapabilitiesSet implements Serializable {
	...
	public int getId_capability() {
		return id_capability;
	}

	public void setId_capability(int id_capability) {
		this.id_capability = id_capability;
	}
