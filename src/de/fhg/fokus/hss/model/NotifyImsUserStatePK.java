...
/** 
 * This is just a help class assisting during notification of ims user states.
 * 
 * @author Hibernate CodeGenerator 
 */
public class NotifyImsUserStatePK implements Serializable {
     ...
     */
    public NotifyImsUserStatePK(Integer impuId, Integer apsvrId) {
        this.impuId = impuId;
        this.apsvrId = apsvrId;
    }

    /** default constructor */
    public NotifyImsUserStatePK() {
    }
    ...
    */
    public boolean equals(Object other) {
        ...
        if ( !(other instanceof NotifyImsUserStatePK) ) return false;
        NotifyImsUserStatePK castOther = (NotifyImsUserStatePK) other;
