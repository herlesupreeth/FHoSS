...
/** 
 * This is just a help class assisting during transactions of NotifyRepData
 * (notification of repository data) objects.
 * 
 * @author Hibernate CodeGenerator 
 */
public class NotifyRepDataPK implements Serializable {
     ...
     */
    public NotifyRepDataPK(Integer impuId, String svcInd, Integer apsvrId) {
        this.impuId = impuId;
        this.svcInd = svcInd;
    ...
    */
    public boolean equals(Object other) {
        ...
        if ( !(other instanceof NotifyRepDataPK) ) return false;
        NotifyRepDataPK castOther = (NotifyRepDataPK) other;
