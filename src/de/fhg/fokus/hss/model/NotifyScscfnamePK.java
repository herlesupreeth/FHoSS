...
/** 
 * This is just a help class containing public user identity and application server
 * identity. It can be used for notification purpose.
 * 
 * @author Hibernate CodeGenerator 
 */
public class NotifyScscfnamePK implements Serializable {
     ...
     */
    public NotifyScscfnamePK(Integer impuId, Integer apsvrId) {
        this.impuId = impuId;
        this.apsvrId = apsvrId;
    }

    /** default constructor */
    public NotifyScscfnamePK() {
    }
    ...
    */
    public boolean equals(Object other) {
        ...
        if ( !(other instanceof NotifyScscfnamePK) ) return false;
        NotifyScscfnamePK castOther = (NotifyScscfnamePK) other;
