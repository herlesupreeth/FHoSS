...
/**
 * This class holds the constant values which indicate the type of server 
 * update being performed in a Server-Assignment-Request operation. For further 
 * details please refer to 3GPP TS 29.229.
 * 
 * @author Andre Charton (dev -at- open-ims dot org)
 */
public class ServerAssignmentTypeAVP
{
