 ...
 */
public class UnknownImpi extends DiameterIMSException
{
    /**
     ...
     */
    public UnknownImpi(String message) {
     ...
     */
    public UnknownImpi(Throwable cause) {
     ...
     *            the cause for this exception
     */
    public UnknownImpi(String message, Throwable cause) {
