...
/**
 * Exception which is thrown if a user is totally unknown to the hss
 * 
  * @author Sebastian Linkiewicz, dev -at- open - ims dot org
 */
public class UnknownGuss extends DiameterIMSException
{
    /**
     * the code of the Diameter error
     */
    public final static int ERRORCODE = 5401;
     ...
     */
    public UnknownGuss(String message) {
     ...
     */
    public UnknownGuss(Throwable cause) {
     ...
     *            the cause for this exception
     */
    public UnknownGuss(String message, Throwable cause) {
